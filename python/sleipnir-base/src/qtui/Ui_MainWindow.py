...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.checkBox_speak.sizePolicy().hasHeightForWidth())
        self.checkBox_speak.setSizePolicy(sizePolicy)
        self.checkBox_speak.setMinimumSize(QSize(0, 0))
        self.checkBox_speak.setChecked(True)

        self.horizontalLayout_3.addWidget(self.checkBox_speak)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_live.setText(QCoreApplication.translate("MainWindow", u"Live Feed", None))
