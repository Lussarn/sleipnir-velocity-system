...
class Sound:
    ...
    def __init__(self):
        ...
        self.sounds['beep'] = pygame.mixer.Sound('assets/sound/beep.ogg')
        self.sounds['beep-beep'] = pygame.mixer.Sound('assets/sound/beep-beep.ogg')
        self.sounds['error'] = pygame.mixer.Sound('assets/sound/error.ogg')
        self.sounds['gate-1'] = pygame.mixer.Sound('assets/sound/gate-1.ogg')
        self.sounds['gate-2'] = pygame.mixer.Sound('assets/sound/gate-2.ogg')
        self.sounds['left'] = pygame.mixer.Sound('assets/sound/left.ogg')
        self.sounds['right'] = pygame.mixer.Sound('assets/sound/right.ogg')
        self.sounds['crossed-the-finish-line'] = pygame.mixer.Sound('assets/sound/crossed-the-finish-line.ogg')
        for i in range (0, 500):
            self.sounds['number-' + str(i)] = pygame.mixer.Sound('assets/sound/numbers/' + str(i) + '.ogg')
